...
class ServiceAgent:
    agents = {
        ...
        'ASM Mesh Data Plane Service Account': (
            'gcp-sa-meshdataplane.iam.gserviceaccount.com', 'roles/meshdataplane.serviceAgent'),
        'Anthos Audit Service Account': ('gcp-sa-anthosaudit.iam.gserviceaccount.com', None),
        'Anthos Config Management Service Account': (
            'gcp-sa-anthosconfigmanagement.iam.gserviceaccount.com', 'roles/anthosconfigmanagement.serviceAgent'),
        'Anthos Identity Service Account': (
            'gcp-sa-anthosidentityservice.iam.gserviceaccount.com', 'roles/anthosidentityservice.serviceAgent'),
        ...
        'App Engine Flexible Environment Service Agent': (
            'gae-api-prod.google.com.iam.gserviceaccount.com', 'roles/appengineflex.serviceAgent'),
        'Artifact Registry Service Agent': (
            'gcp-sa-artifactregistry.iam.gserviceaccount.com', 'roles/artifactregistry.serviceAgent'),
        ...
        'AutoML Recommendations Service Account': (
            'gcp-sa-recommendationengine.iam.gserviceaccount.com', 'roles/automlrecommendations.serviceAgent'),
        'AutoML Service Agent': ('gcp-sa-automl.iam.gserviceaccount.com', 'roles/automl.serviceAgent'),
        'BigQuery Connection Service Agent': (
            'gcp-sa-bigqueryconnection.iam.gserviceaccount.com', 'roles/bigqueryconnection.serviceAgent'),
        'BigQuery Data Transfer Service Agent': (
            'gcp-sa-bigquerydatatransfer.iam.gserviceaccount.com', 'roles/bigquerydatatransfer.serviceAgent'),
        'BigQuery Omni Service Agent': ('gcp-sa-prod-bigqueryomni.iam.gserviceaccount.com', None),
        'Binary Authorization Service Agent': (
            'gcp-sa-binaryauthorization.iam.gserviceaccount.com', 'roles/binaryauthorization.serviceAgent'),
        'Cloud AI Platform Notebooks Service Account': (
            'gcp-sa-notebooks.iam.gserviceaccount.com', 'roles/notebooks.serviceAgent'),
        'Cloud API Gateway Management Plane Service Account': (
            'gcp-sa-apigateway-mgmt.iam.gserviceaccount.com', None),
        'Cloud API Gateway Service Account': ('gcp-sa-apigateway.iam.gserviceaccount.com', None),
        'Cloud Asset Service Agent': (
            'gcp-sa-cloudasset.iam.gserviceaccount.com', 'roles/cloudasset.serviceAgent'),
        'Cloud Bigtable Service Agent': ('gcp-sa-bigtable.iam.gserviceaccount.com', None),
        'Cloud Build Service Agent': (
            'gcp-sa-cloudbuild.iam.gserviceaccount.com', 'roles/cloudbuild.serviceAgent'),
        'Cloud Composer Service Agent': (
            'cloudcomposer-accounts.iam.gserviceaccount.com', 'roles/composer.serviceAgent'),
        'Cloud Data Fusion Service Account': (
            'gcp-sa-datafusion.iam.gserviceaccount.com', 'roles/datafusion.serviceAgent'),
        'Cloud Database Migration Service Account': ('gcp-sa-datamigration.iam.gserviceaccount.com', None),
        'Cloud Dataflow Service Account': (
            'dataflow-service-producer-prod.iam.gserviceaccount.com', 'roles/dataflow.serviceAgent'),
        'Cloud Endpoints Service Agent': (
            'gcp-sa-endpoints.iam.gserviceaccount.com', 'roles/endpoints.serviceAgent'),
        ...
        'Cloud Healthcare Service Agent': (
            'gcp-sa-healthcare.iam.gserviceaccount.com', 'roles/healthcare.serviceAgent'),
        'Cloud IoT Core Service Agent': (
            'gcp-sa-cloudiot.iam.gserviceaccount.com', 'roles/cloudiot.serviceAgent'),
        ...
        'Cloud Life Sciences Service Agent': (
            'gcp-sa-lifesciences.iam.gserviceaccount.com', 'roles/lifesciences.serviceAgent'),
        'Cloud Logging Service Account': ('gcp-sa-logging.iam.gserviceaccount.com', None),
        'Cloud Managed Identities Service Agent': (
            'gcp-sa-mi.iam.gserviceaccount.com', 'roles/managedidentities.serviceAgent'),
        'Cloud Memorystore Memcache Service Agent': (
            'cloud-memcache-sa.iam.gserviceaccount.com', 'roles/memcache.serviceAgent'),
        'Cloud Memorystore Redis Service Agent': (
            'cloud-redis.iam.gserviceaccount.com', 'roles/redis.serviceAgent'),
        'Cloud Network Management Service Account': (
            'gcp-sa-networkmanagement.iam.gserviceaccount.com', 'roles/networkmanagement.serviceAgent'),
        ...
        'Cloud Scheduler Service Account': (
            'gcp-sa-cloudscheduler.iam.gserviceaccount.com', 'roles/cloudscheduler.serviceAgent'),
        'Cloud Security Command Center Notification Service Account': (
            'gcp-sa-scc-notification.iam.gserviceaccount.com', 'roles/securitycenter.notificationServiceAgent'),
        'Cloud Source Repositories Service Agent': (
            'sourcerepo-service-accounts.iam.gserviceaccount.com', 'roles/sourcerepo.serviceAgent'),
        'Cloud Spanner Production Service Account': ('gcp-sa-spanner.iam.gserviceaccount.com', None),
        'Cloud Storage for Firebase Service Agent': (
            'gcp-sa-firebasestorage.iam.gserviceaccount.com', 'roles/firebasestorage.serviceAgent'),
        'Cloud Tasks Service Account': (
            'gcp-sa-cloudtasks.iam.gserviceaccount.com', 'roles/cloudtasks.serviceAgent'),
        'Cloud Trace Service Account': ('gcp-sa-cloud-trace.iam.gserviceaccount.com', None),
        'Cloud Translation Service Agent': (
            'gcp-sa-translation.iam.gserviceaccount.com', 'roles/cloudtranslate.serviceAgent'),
        ...
        'Cloud Web Security Scanner Service Agent': (
            'gcp-sa-websecurityscanner.iam.gserviceaccount.com', 'roles/websecurityscanner.serviceAgent'),
        'Cloud Workflows Service Agent': (
            'gcp-sa-workflows.iam.gserviceaccount.com', 'roles/workflows.serviceAgent'),
        ...
        'Compute Scanning Service Agent': (
            'gcp-sa-computescanning.iam.gserviceaccount.com', 'roles/computescanning.serviceAgent'),
        'Container Analysis Service Agent': (
            'container-analysis.iam.gserviceaccount.com', 'roles/containeranalysis.ServiceAgent'),
        'Container Scanning Service Agent': (
            'gcp-sa-containerscanning.iam.gserviceaccount.com', 'roles/containerscanning.ServiceAgent'),
        'Container Threat Detection Service Agent': (
            'gcp-sa-ktd-control.iam.gserviceaccount.com', 'roles/containerthreatdetection.serviceAgent'),
        'Data Labeling Service Account': (
            'gcp-sa-datalabeling.iam.gserviceaccount.com', 'roles/datalabeling.serviceAgent'),
        'Data Studio Service Account': (
            'gcp-sa-datastudio.iam.gserviceaccount.com', 'roles/datastudio.serviceAgent'),
        'Dataproc Metastore Service Account': ('gcp-sa-metastore.iam.gserviceaccount.com', None),
        'Dialogflow Service Agent': (
            'gcp-sa-dialogflow.iam.gserviceaccount.com', 'roles/dialogflow.serviceAgent'),
        'DocumentAI Core Service Agent': (
            'gcp-sa-prod-dai-core.iam.gserviceaccount.com', 'roles/documentaicore.serviceAgent'),
        'Endpoints Consumer Portal Service Agent': (
            'endpoints-portal.iam.gserviceaccount.com', 'roles/endpointsportal.serviceAgent'),
        ...
        'Firebase Extensions Service Agent': (
            'gcp-sa-firebasemods.iam.gserviceaccount.com', 'roles/firebasemods.serviceAgent'),
        'Firebase Rules Service Agent': ('firebase-rules.iam.gserviceaccount.com', None),
        'Firewall Insights Service Account': (
            'gcp-sa-firewallinsights.iam.gserviceaccount.com', 'roles/firewallinsights.serviceAgent'),
        ...
        'Google Cloud Dataproc Service Agent': (
            'dataproc-accounts.iam.gserviceaccount.com', 'roles/dataproc.serviceAgent'),
        ...
        'Google Cloud ML Engine Service Agent': (
            'cloud-ml.google.com.iam.gserviceaccount.com', 'roles/ml.serviceAgent'),
        'Google Cloud OS Config Service Agent': (
            'gcp-sa-osconfig.iam.gserviceaccount.com', 'roles/osconfig.serviceAgent'),
        ...
        'Google Genomics Service Agent': (
            'genomics-api.google.com.iam.gserviceaccount.com', 'roles/genomics.serviceAgent'),
        'Kubernetes Engine Service Agent': (
            'container-engine-robot.iam.gserviceaccount.com', 'roles/container.serviceAgent'),
        'Mesh Config Service Account': (
            'gcp-sa-meshconfig.iam.gserviceaccount.com', 'roles/meshconfig.serviceAgent'),
        'Monitoring Notification Service Account': (
            'gcp-sa-monitoring-notification.iam.gserviceaccount.com', 'roles/monitoring.notificationServiceAgent'),
        'Multi Cluster Ingress Service Account': (
            'gcp-sa-multiclusteringress.iam.gserviceaccount.com', 'roles/multiclusteringress.serviceAgent'),
        'Multi cluster metering Service Account': (
            'gcp-sa-mcmetering.iam.gserviceaccount.com', 'roles/multiclustermetering.serviceAgent'),
        'Private CA Service Account': ('gcp-sa-privateca.iam.gserviceaccount.com', None),
        'Remote Build Execution Service Agent': (
            'remotebuildexecution.iam.gserviceaccount.com', 'roles/remotebuildexecution.serviceAgent'),
        ...
        'Serverless VPC Access Service Agent': (
            'gcp-sa-vpcaccess.iam.gserviceaccount.com', 'roles/vpcaccess.serviceAgent'),
        'Service Consumer Management Service Agent': (
            'service-consumer-management.iam.gserviceaccount.com', None),
        'Service Directory Service Account': ('gcp-sa-servicedirectory.iam.gserviceaccount.com', None),
        'Service Networking Service Agent': (
            'service-networking.iam.gserviceaccount.com', 'roles/servicenetworking.serviceAgent'),
